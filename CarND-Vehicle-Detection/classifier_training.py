...
training_labels = []
images = glob.glob('training_images/udacity/vehicles/*/*.png', recursive = True)
cars = []
...
images = glob.glob('training_images/udacity/non-vehicles/*/*.png', recursive = True)
notcars = []
...
joblib.dump(svc, 'svc_ycrcb2_pickle.p') # fig = plt.figure()

scaler_pickle = {}
scaler_pickle["X_scaler"] = X_scaler

pickle.dump( scaler_pickle, open( "scaler_pickle.p", "wb" ) )
